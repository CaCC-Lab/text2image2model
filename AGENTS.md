...
# プロジェクト固有情報 (Project Specifics)

## 📂 Simple Todo List
- **メインファイル**: `todo_list.py`
- **テストコマンド**:
  - 推奨: `python3 -m pytest test_todo_list_comprehensive.py -v`
  - 代替: `python3 run_todo_manual_tests.py` (依存関係なし)
- **ステータス**: Production Ready (QA完了済み)
- **ドキュメント**: `PROJECT_STATUS.md` を参照
